...
public class A58Group implements Group {
    ...
    public FormIndividualGroup create() {
        ...
        final CompositeField compositeFieldGroupChildDateOfBirth =
                getCompositeFieldGroupChildDateOfBirth();
        ...
        final TextField childPlacedAdoptionAgencyContactName =
                getChildPlacedAdoptionAgencyContactName();
        final PhoneNumberField childPlacedAdoptionAgencyTelephoneNo =
                getChildPlacedAdoptionAgencyTelephoneNo();
    ...
    private CompositeField getCompositeFieldGroupChildMaintanenceOrder() {
        ...
        final CompositeField childMaintanenceOrder =
                CompositeField.builder()
        ...
        CheckboxField childNoMaintanenceOrder =
    ...
    private CompositeField getCompositeFieldGroupchildLaOrParentalResponsibilityDetails() {
        ...
        final CompositeField childLaOrParentalResponsibilityDetails =
                CompositeField.builder()
                        ...
                        .fieldRequiredType(FieldRequiredTypeEnum.MANDATORY)
                        .build();
        childLaOrParentalResponsibilityDetails.add(
                TextField.builder()
        ...
        final CheckboxField childNoLaOrParentalResponsibility =
                CheckboxField.builder()
                        .name("child_noLaOrParentalResponsibility")
                        .fieldRequiredType(FieldRequiredTypeEnum.MANDATORY)
                        .build();

        compositeFieldGroupchildLaOrParentalResponsibilityDetails.add(
                childLaOrParentalResponsibilityDetails);
        compositeFieldGroupchildLaOrParentalResponsibilityDetails.add(
                childNoLaOrParentalResponsibility);
        return compositeFieldGroupchildLaOrParentalResponsibilityDetails;
    }

    private CompositeField getCompositeFieldGroupChildCourt() {
        // Group field
        final CompositeField compositeFieldGroupChildCourt =
                CompositeField.builder()
                        .selectorType(SelectorEnum.ONE_CHILD_REQUIRED)
                        .fieldType(FieldTypeEnum.ROOT)
                        .build();

        final CompositeField childPlacementOrderByEnglandAndWalesCourt =
                getChildPlacementOrderByEnglandAndWalesCourt();

        final CompositeField childFreeingOrderByEnglandAndWalesCourt =
                getChildFreeingOrderByEnglandAndWalesCourt();

        final CompositeField childFreeingOrderByNorthernIrelandCourt =
                getChildFreeingOrderByNorthernIrelandCourt();

        final CompositeField childPermanenceOrderByScotlandCourt =
                getChildPermanenceOrderByScotlandCourt();

        final CheckboxField childNoOrderAvaialble =
                CheckboxField.builder()
    ...
    private CompositeField getChildFreeingOrderByEnglandAndWalesCourt() {
        final CompositeField childFreeingOrderByEnglandAndWalesCourt =
                CompositeField.builder()
                        ...
                        .fieldRequiredType(FieldRequiredTypeEnum.MANDATORY)
                        .build();
        childFreeingOrderByEnglandAndWalesCourt.add(
                TextField.builder()
    ...
    private CompositeField getChildPermanenceOrderByScotlandCourt() {
        final CompositeField childPermanenceOrderByScotlandCourt =
                CompositeField.builder()
                        ...
                        .fieldRequiredType(FieldRequiredTypeEnum.MANDATORY)
                        .build();
        childPermanenceOrderByScotlandCourt.add(
                TextField.builder()
    ...
    private CompositeField getChildFreeingOrderByNorthernIrelandCourt() {
        final CompositeField childFreeingOrderByNorthernIrelandCourt =
                CompositeField.builder()
                        ...
                        .fieldRequiredType(FieldRequiredTypeEnum.MANDATORY)
                        .build();
        childFreeingOrderByNorthernIrelandCourt.add(
                TextField.builder()
    ...
    private CompositeField getChildPlacementOrderByEnglandAndWalesCourt() {
        final CompositeField childPlacementOrderByEnglandAndWalesCourt =
                CompositeField.builder()
                        ...
                        .fieldRequiredType(FieldRequiredTypeEnum.MANDATORY)
                        .build();
        childPlacementOrderByEnglandAndWalesCourt.add(
                TextField.builder()
    ...
    private CompositeField getCompositeFieldGroupchildAdoptionAgencyDetailsAvailable() {
        ...
        CompositeField childIsAdoptionAgencyDetailsAvailable =
                CompositeField.builder()
                        ...
                        .fieldRequiredType(FieldRequiredTypeEnum.MANDATORY)
                        .build();
        childIsAdoptionAgencyDetailsAvailable.add(
                DateField.builder()
        ...
        CheckboxField childIsAdoptionAgencyInvolved =
                CheckboxField.builder()
                        .name("child_isAdoptionAgencyInvolved")
                        .fieldRequiredType(FieldRequiredTypeEnum.MANDATORY)
                        .build();

        compositeFieldGroupchildAdoptionAgencyDetailsAvailable.add(
                childIsAdoptionAgencyDetailsAvailable);
    ...
    private CompositeField getCompositeFieldGroupChildDateOfBirth() {
        ...
        CompositeField compositeFieldGroupChildDateOfBirth =
                CompositeField.builder()
                        .selectorType(SelectorEnum.ONE_CHILD_REQUIRED)
                        .fieldType(FieldTypeEnum.ROOT)
                        .build();

        CompositeField childApproximateDateOfBirth =
                CompositeField.builder()
        ...
        childApproximateDateOfBirth.add(
                TextField.builder()
                        .name("child_placeAndCountryOfBirth")
                        .fieldRequiredType(FieldRequiredTypeEnum.MANDATORY)
                        .build());

        DateField childDateOfBirth =
                DateField.builder()
    ...
    private CompositeField getCompositeFieldGroupChildProceedingDetailsWithRelation() {
        ...
        final CompositeField childProceedingDetailsWithRelation =
                CompositeField.builder()
                        ...
                        .fieldRequiredType(FieldRequiredTypeEnum.MANDATORY)
                        .build();
        childProceedingDetailsWithRelation.add(
                TextField.builder()
        ...
        CheckboxField childNoProccedingDetailsWithRelation =
                CheckboxField.builder()
                        .name("child_noProccedingDetailsWithRelation")
                        .fieldRequiredType(FieldRequiredTypeEnum.MANDATORY)
                        .build();
        CheckboxField childDontKnowProceedingDetailsWithRelation =
                CheckboxField.builder()
                        .name("child_dontKnowProceedingDetailsWithRelation")
                        .fieldRequiredType(FieldRequiredTypeEnum.MANDATORY)
                        .build();

        compositeFieldGroupChildProceedingDetailsWithRelation.add(
                childProceedingDetailsWithRelation);
        compositeFieldGroupChildProceedingDetailsWithRelation.add(
                childNoProccedingDetailsWithRelation);
        compositeFieldGroupChildProceedingDetailsWithRelation.add(
                childDontKnowProceedingDetailsWithRelation);
    ...
    private CompositeField getCompositeFieldGroupChildProceedingDetails() {
        ...
        final CompositeField childProceedingDetails =
                CompositeField.builder()
        ...
        final CheckboxField childNoProceedingDetails =
                CheckboxField.builder()
