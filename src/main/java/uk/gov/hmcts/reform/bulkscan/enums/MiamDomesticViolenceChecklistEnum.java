...
public enum MiamDomesticViolenceChecklistEnum {
    miamDomesticViolenceChecklistEnum_Value_1(
            "Evidence that a prospective party has been arrested for a relevant domestic violence"
                    + " offence;"),
    miamDomesticViolenceChecklistEnum_Value_2(
    ...
    miamDomesticViolenceChecklistEnum_Value_4(
    ...
    miamDomesticViolenceChecklistEnum_Value_8(
            "An undertaking given in England and Wales under section 46 or 63E of the Family Law"
                + " Act 1996 (or given in Scotland or Northern Ireland in place of a protective"
                + " injunction) by a prospective party, provided that a cross- undertaking relating"
                + " to domestic violence was not given by another prospective party;"),
    ...
    miamDomesticViolenceChecklistEnum_Value_10(
            "An expert report produced as evidence in proceedings in the United Kingdom for the"
                ...
                + " party is or was in a family relationship, was assessed as being, or at risk of"
                + " being, a victim of domestic violence by that prospective party;"),
    miamDomesticViolenceChecklistEnum_Value_11(
            "A letter or report from an appropriate health professional confirming that- \r\n"
                + "(i)  that professional,or another appropriate health professional, has examined"
                + " a prospective party in person; and (ii)  in the reasonable professional"
                + " judgment of the author or the examining appropriate health professional, that"
                + " prospective party has, or has had, injuries or a condition consistent with"
    ...
    miamDomesticViolenceChecklistEnum_Value_13(
            "A letter from any person who is a member of a multi-agency risk assessment conference"
                + " (or other suitable local safeguarding forum) confirming that a prospective"
                + " party, or a person with whom that prospective party is in a family"
                + " relationship, is or has been at risk of harm from domestic violence by another"
                + " prospective party;"),
    miamDomesticViolenceChecklistEnum_Value_15(
            "A letter from an independent domestic violence advisor confirming "
                    + "that they are providing support to a prospective party;"),
    miamDomesticViolenceChecklistEnum_Value_16(
            "A letter from an independent sexual violence advisor confirming "
                    + "that they are providing support to a prospective party"
                    + " relating to sexual violence by another prospective party;"),
    miamDomesticViolenceChecklistEnum_Value_17(
            "A letter from an officer employed by a local authority or housing association (or"
                + " their equivalent in Scotland or Northern Ireland) for the purpose of supporting"
                + " tenants containing- \r\n"
                + "(i)  a statement to the effect that, in their reasonable professional judgment,"
                + " a person with whom a prospective party is or has been in a family relationship"
                + " is, or is at risk of being, a victim of domestic violence by that prospective"
                + " party; (ii)  a description of the specific matters relied upon to support that"
                + " judgment; and (iii) a description of the support they provided to the victim of"
                + " domestic violence or the person at risk of domestic violence by that"
                + " prospective party;"),
    miamDomesticViolenceChecklistEnum_Value_18(
            "A letter which- \r\n"
                ...
                + " \r\n"
                + "(c) provided a prospective party with support in relation to that person’s needs"
                + " as a victim, or a person at risk, of domestic violence; and \r\n"
                + "(ii) contains- \r\n"
                + "(a) a statement to the effect that, in the reasonable professional judgment of"
                + " the author of the letter, the prospective party is, or is at risk of being, a"
    ...
    miamDomesticViolenceChecklistEnum_Value_20(
            "A letter from a public authority confirming that a person with "
                    + "whom a prospective party is or was in a family relationship, was assessed"
                    + " as being, or at risk of being, a victim of domestic violence "
                    + "by that prospective party (or a copy of that assessment);"),
    miamDomesticViolenceChecklistEnum_Value_21(
            "A letter from the Secretary of State for the Home Department confirming that a"
                ...
                + " paragraph 289B of the Rules made by the Home Secretary under section 3(2) of"
                + " the Immigration Act 1971, which can be found at https://www."
