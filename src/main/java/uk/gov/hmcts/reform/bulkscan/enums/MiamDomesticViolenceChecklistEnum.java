...
public enum MiamDomesticViolenceChecklistEnum {
    ...
    miamDomesticViolenceChecklistEnum_Value_2("Evidence of a relevant police caution "
    ...
    miamDomesticViolenceChecklistEnum_Value_4("Evidence of a relevant conviction "
                                                  + "for a domestic violence offence;"),
    ...
    miamDomesticViolenceChecklistEnum_Value_11(
        "A letter or report from an appropriate health professional confirming "
            + "that- \r\n(i)  that professional,"
            + "or another appropriate health professional,"
            + " has examined a prospective party in person; "
            + "and (ii)  in the reasonable professional judgment "
            + "of the author or the examining appropriate health professional, "
            + "that prospective party has, or has had, "
            + "injuries or a condition consistent with being a victim of domestic violence;"),
    miamDomesticViolenceChecklistEnum_Value_12(
        "A letter or report from- \r\n(i) the appropriate health professional "
            + "who made the referral described below; "
            + "\r\n(ii) an appropriate health "
            + "professional who has access to the medical records of the prospective party referred to below; "
    ...
    miamDomesticViolenceChecklistEnum_Value_13(
        "A letter from any person who is a member of a multi-agency risk assessment conference "
            + "(or other suitable local safeguarding forum)"
    ...
    miamDomesticViolenceChecklistEnum_Value_17(
        "A letter from an officer employed by a local authority or "
            + "housing association (or their equivalent in Scotland or Northern Ireland) "
            + "for the purpose of supporting tenants containing- \r\n(i)  a statement to the effect that, "
            + "in their reasonable professional judgment, "
            + "a person with whom a prospective party is or has been in a family relationship is, "
    ...
    miamDomesticViolenceChecklistEnum_Value_18(
        "A letter which- \r\n(i) is from an organisation providing domestic violence"
            ...
            + "the prospective party is, or is at risk of being, "
    ...
    miamDomesticViolenceChecklistEnum_Value_19(
        "A letter or report from an organisation providing domestic violence support services "
            ...
            + "person with whom a prospective party is or "
            + "was in a family relationship was refused admission to a refuge; \r\n(ii) the date on which "
            + "they were refused admission to the refuge; "
