...
public enum MiamUrgencyReasonChecklistEnum {
    ...
    miamUrgencyReasonChecklistEnum_Value_2(
            "Any delay caused by MIAM would cause significant risk "
                    + "of a miscarriage of justice"),
    miamUrgencyReasonChecklistEnum_Value_3(
            "Any delay caused by MIAM would cause unreasonable hardship "
                    + "to the prospective applicant"),
    miamUrgencyReasonChecklistEnum_Value_4(
            "Any delay caused by MIAM would cause irretrievable problems "
                    + "in dealing with the dispute "
                    + "(including the irretrievable loss of significant evidence)"),
    miamUrgencyReasonChecklistEnum_Value_5(
            "There  is a significant risk that in the period necessary "
    ...
    miamUrgencyReasonChecklistEnum_Value_6(
            "There is a risk of unlawful removal "
