...
public interface Selector {
    List<Field> apply(List<Field> fieldList, List<OcrDataField> ocrDataFields, SelectorEnum selectorType,
                      ErrorAndWarningHandler errorAndWarningHandler);

    default List<Field> getSelectedFieldList(List<Field> fieldList, List<OcrDataField> ocrDataFields) {
