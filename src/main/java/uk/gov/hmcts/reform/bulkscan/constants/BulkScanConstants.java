...
public final class BulkScanConstants {
    ...
    public static final String NO_MIAM_DVE_ARRESTED_FOR_SIMILAR_OFFENCE = "NoMIAM_DVE_arrestedForSimilarOffence";
    public static final String NO_MIAM_DVE_RELEVANT_POLICE_CAUTION = "NoMIAM_DVE_relevantPoliceCaution";
    public static final String NO_MIAM_DVE_RELEVANT_CRIMINAL_PROCEEDING = "NoMIAM_DVE_relevantCriminalProceeding";
    ...
    public static final String NO_MIAM_DVE_PROTECTIVE_INJUNCTION = "NoMIAM_DVE_protectiveInjunction";
    public static final String NO_MIAM_DVE_NO_CROSS_UNDERTAKING_GIVEN = "NoMIAM_DVE_NoCrossUndertakingGiven";
    public static final String NO_MIAM_DVE_COPY_OF_FACT_FINDING = "NoMIAM_DVE_copyOfFactFinding";
    public static final String NO_MIAM_DVE_EXPERT_EVIDENCE_REPORT = "NoMIAM_DVE_expertEvidenceReport";
    public static final String NO_MIAM_DVE_HEALTH_PROFESSIONAL_REPORT = "NoMIAM_DVE_healthProfessionalReport";
    public static final String NO_MIAM_DVE_REFERRAL_HEALTH_PROFESSIONAL_REPORT
        = "NoMIAM_DVE_ReferralHealthProfessionalReport";
    public static final String NO_MIAM_DVE_MEMBER_OF_MULTI_AGENCY_RISK_ASSESSMENT_CONFERRANCE_LETTER
        = "NoMIAM_DVE_memberOf_MultiAgencyRiskAssessmentConferrance_letter";
    public static final String NO_MIAM_DVE_DOMESTIC_VIOLENCE_ADVISOR = "NoMIAM_DVE_domesticViolenceAdvisor";
