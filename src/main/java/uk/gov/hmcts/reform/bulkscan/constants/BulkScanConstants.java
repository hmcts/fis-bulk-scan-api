...
public final class BulkScanConstants {
    ...
    public static final String CCD_RELATIONSHIP_DATE_COMPLEX_END_DATE_FIELD =
            "relationshipDateComplexEndDate";
    public static final String CCD_APPLICANT_RELATIONSHIOP_DATE = "applicantRelationshipDate";
