...
public class MandatoryFieldValidator implements FieldValidator {
    @Override
    public void validate(String fieldName, FieldTypeEnum fieldType, Optional<OcrDataField> ocrDataFieldOptional,
        ...
        if (!ocrDataFieldOptional.isPresent()) {
            ...
            String error = formatValidator.validateFormat(fieldName, ocrDataFieldOptional.get().getValue());
