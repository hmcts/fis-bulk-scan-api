...
public final class Constants {
    ...
    public static final String FL401_CASE_TYPE_VALIDATE_ENDPOINT = "/forms/FL401/validate";
    public static final String FL403_CASE_TYPE_VALIDATE_ENDPOINT = "/forms/FL403/validate";
    ...
    public static final String WELCOME_BULK_SCAN_API_MESSAGE = "Welcome to fis-bulk-scan-api";
