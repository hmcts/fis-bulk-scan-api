...
public class Constant {
    ...
    public static final String FGM001_TRANSFORM_INPUT_PATH =
            "classpath:requests/bulk-scan-fgm001-transform-input.json";
    public static final String FGM001_TRANSFORM_OUTPUT_PATH =
            "classpath:responses/bulk-scan-fgm001-transform-output.json";
    ...
    public static final String FL401A_TRANSFORM_INPUT_PATH =
            "classpath:requests/bulk-scan-fl401a-transform-input.json";
    public static final String FL401A_TRANSFORM_OUTPUT_PATH =
            "classpath:responses/bulk-scan-fl401a-transform-output.json";
    ...
    public static final String FGM001_CASE_TYPE_VALIDATE_ENDPOINT = "/forms/FGM001/validate-ocr";
