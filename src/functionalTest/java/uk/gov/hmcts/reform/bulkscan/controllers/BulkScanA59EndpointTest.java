...
public class BulkScanA59EndpointTest {
    ...
    public void shouldValidate59BulkScanRequest() throws Exception {
        String bulkScanValidationRequest =
            readFileFrom(A59_VALIDATION_INPUT_PATH);

        String bulkScanValidationResponse =
            readFileFrom(A59_VALIDATION_OUTPUT_PATH);
    ...
    public void validationErrorForA59BulkScanRequest() throws Exception {
        String bulkScanValidationRequest =
            readFileFrom(A59_VALIDATION_ERROR_INPUT_PATH);

        String bulkScanValidationResponse =
            readFileFrom(A59_VALIDATION_ERROR_OUTPUT_PATH);
    ...
    public void shouldTransformA59BulkScanRequest() throws Exception {
        String bulkScanTransformRequest =
            readFileFrom(A59_TRANSFORM_INPUT_PATH);

        String bulkScanTransformResponse =
            readFileFrom(A59_TRANSFORM_OUTPUT_PATH);
