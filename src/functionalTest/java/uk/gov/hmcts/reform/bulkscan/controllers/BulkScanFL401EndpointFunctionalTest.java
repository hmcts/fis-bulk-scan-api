...
public class BulkScanFL401EndpointFunctionalTest {
    ...
    private static final String FL401_VALIDATION_INPUT_PATH =
            "classpath:requests/bulk-scan-fl401-validate-input.json";
    private static final String FL401_VALIDATION_OUTPUT_PATH =
            "classpath:responses/bulk-scan-fl401-validate-output.json";
    ...
    @DisplayName("FL401 request should generate response with results")
    @Test
