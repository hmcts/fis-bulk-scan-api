...
class BulkScanA58PostPlacementServiceTest {
    ...
    void testA58PostPlacementApplicationValidationSuccess() throws IOException {
        BulkScanValidationRequest bulkScanValidationRequest =
                mapper.readValue(
                        readFileFrom(A58_POST_PLACEMENT_REQUEST_PATH),
    ...
    void testA58PostPlacementApplicationValidationWithWarning() throws IOException {
        BulkScanValidationRequest bulkScanValidationRequest =
                mapper.readValue(
                        readFileFrom(A58_POST_PLACEMENT_WARNING_REQUEST_PATH),
                        BulkScanValidationRequest.class);
        BulkScanValidationResponse res =
                bulkScanValidationService.validate(bulkScanValidationRequest);
    ...
    void testA58PostPlacementApplicationValidationUnknownFieldWarning() throws IOException {
        BulkScanValidationRequest bulkScanValidationRequest =
                mapper.readValue(
                        readFileFrom(A58_POST_PLACEMENT_UNKNOWN_FIELD_REQUEST_PATH),
                        BulkScanValidationRequest.class);
        BulkScanValidationResponse res =
                bulkScanValidationService.validate(bulkScanValidationRequest);
    ...
    void testA58PostPlacementApplicationMandatoryErrorWhileDoingValidation() throws IOException {
        BulkScanValidationRequest bulkScanValidationRequest =
                mapper.readValue(
                        readFileFrom(A58_POST_PLACEMENT_ERROR_FIELD_REQUEST_PATH),
                        BulkScanValidationRequest.class);
        BulkScanValidationResponse res =
                bulkScanValidationService.validate(bulkScanValidationRequest);
        assertTrue(
    ...
    void testA58PostPlacementApplicationTransformSuccess() throws IOException, JSONException {
        BulkScanTransformationRequest bulkScanTransformationRequest =
                mapper.readValue(
                        readFileFrom(A58_POST_PLACEMENT_TRANSFORM_REQUEST_PATH),
    ...
    void testA58PostPlacementApplicationTransformApplicantSuccess() {
        ...
        BulkScanTransformationResponse res =
                bulkScanValidationService.transform(bulkScanTransformationRequest);
        assertEquals(
                MaritalStatusEnum.OTHER_PARENT_EXCLUSION_JUSTIFIED.getName(),
    ...
    void testA58PostPlacementApplicationTransformWithNoOtherParent() {
        BulkScanTransformationRequest bulkScanTransformationRequest =
                BulkScanTransformationRequest.builder()
                        ...
                        .ocrdatafields(
                                getOcrDataFields(
                                        "applicant_applying_alone_no_other_parent", "true"))
                        .build();

        BulkScanTransformationResponse res =
                bulkScanValidationService.transform(bulkScanTransformationRequest);
        assertEquals(
                MaritalStatusEnum.NO_OTHER_PARENT.getName(),
                res.getCaseCreationDetails().getCaseData().get("applicantMaritalStatus"));
    }
    ...
    void testA58PostPlacementApplicationTransformWithNaturalOtherParent() {
        ...
        BulkScanTransformationResponse res =
                bulkScanValidationService.transform(bulkScanTransformationRequest);
        assertEquals(
                MaritalStatusEnum.NATURAL_PARENT_NOT_FOUND.getName(),
                res.getCaseCreationDetails().getCaseData().get("applicantMaritalStatus"));
    }
    ...
    void testA58PostPlacementApplicationTransformWithNaturalParentDied() {
        BulkScanTransformationRequest bulkScanTransformationRequest =
                BulkScanTransformationRequest.builder()
                        ...
                        .ocrdatafields(
                                getOcrDataFields(
                                        "applicant_applying_alone_natural_parent_died", "true"))
                        .build();

        BulkScanTransformationResponse res =
                bulkScanValidationService.transform(bulkScanTransformationRequest);
        assertEquals(
                MaritalStatusEnum.NATURAL_PARAENT_DIED.getName(),
                res.getCaseCreationDetails().getCaseData().get("applicantMaritalStatus"));
    }
    ...
    void testA58PostPlacementApplicationTransformWithSpouseIncapable() {
        ...
        BulkScanTransformationResponse res =
                bulkScanValidationService.transform(bulkScanTransformationRequest);
        assertEquals(
                MaritalStatusEnum.SPOUSE_INCAPABLE.getName(),
                res.getCaseCreationDetails().getCaseData().get("applicantMaritalStatus"));
    }
    ...
    void testA58PostPlacementApplicationTransformWithSpouseSeparated() {
        ...
        BulkScanTransformationResponse res =
                bulkScanValidationService.transform(bulkScanTransformationRequest);
        assertEquals(
                MaritalStatusEnum.SPOUSE_SEPARATED.getName(),
                res.getCaseCreationDetails().getCaseData().get("applicantMaritalStatus"));
    }
    ...
    void testA58PostPlacementApplicationTransformWithSpouseNotFound() {
        BulkScanTransformationRequest bulkScanTransformationRequest =
                BulkScanTransformationRequest.builder()
                        ...
                        .ocrdatafields(
                                getOcrDataFields(
                                        "applicant_marital_status_married_spouse_notfound", "true"))
                        .build();

        BulkScanTransformationResponse res =
                bulkScanValidationService.transform(bulkScanTransformationRequest);
        assertEquals(
                MaritalStatusEnum.SPOUSE_NOT_FOUND.getName(),
                res.getCaseCreationDetails().getCaseData().get("applicantMaritalStatus"));
    }
    ...
    void testA58PostPlacementApplicationTransformWithWidow() {
        ...
        BulkScanTransformationResponse res =
                bulkScanValidationService.transform(bulkScanTransformationRequest);
        assertEquals(
                MaritalStatusEnum.WIDOW.getName(),
                res.getCaseCreationDetails().getCaseData().get("applicantMaritalStatus"));
    }
    ...
    void testA58PostPlacementApplicationTransformWithDivorced() {
        BulkScanTransformationRequest bulkScanTransformationRequest =
                BulkScanTransformationRequest.builder()
                        ...
                        .caseTypeId("A58")
                        .ocrdatafields(
                                getOcrDataFields("applicant_marital_status_divorced", "true"))
                        .build();

        BulkScanTransformationResponse res =
                bulkScanValidationService.transform(bulkScanTransformationRequest);
        assertEquals(
                MaritalStatusEnum.DIVORCED.getName(),
                res.getCaseCreationDetails().getCaseData().get("applicantMaritalStatus"));
    }
    ...
    void testA58PostPlacementApplicationTransformWithSingle() {
        ...
        BulkScanTransformationResponse res =
                bulkScanValidationService.transform(bulkScanTransformationRequest);
        assertEquals(
                MaritalStatusEnum.SINGLE.getName(),
                res.getCaseCreationDetails().getCaseData().get("applicantMaritalStatus"));
    }
    ...
    void testA58PostPlacementApplicationRelationToChild() {
        BulkScanTransformationRequest bulkScanTransformationRequest =
                BulkScanTransformationRequest.builder()
                        ...
                        .ocrdatafields(
                                getOcrDataFields(
                                        "applicant_relationToChild_mother_partner", "true"))
                        .build();

        BulkScanTransformationResponse res =
                bulkScanValidationService.transform(bulkScanTransformationRequest);
        assertEquals(
                RelationToChildEnum.MOTHER.getName(),
    ...
    void testA58PostPlacementApplicationRelationToChildAsCivil() {
        BulkScanTransformationRequest bulkScanTransformationRequest =
                BulkScanTransformationRequest.builder()
                        ...
                        .ocrdatafields(
                                getOcrDataFields(
                                        "applicant_relationToChild_non_civil_partner", "true"))
                        .build();

        BulkScanTransformationResponse res =
                bulkScanValidationService.transform(bulkScanTransformationRequest);
        assertEquals(
                RelationToChildEnum.CIVIL.getName(),
                res.getCaseCreationDetails().getCaseData().get("applicantRelationToChild"));
    }
