...
class BulkValidationHelperTest {
    ...
    @InjectMocks BulkScanValidationHelper bulkScanValidationHelper;
    ...
    void testSuccessScenario() {
        ValidationConfig validationConfig =
                validationConfigFactory.getValidationConfig(FormType.C100.toString());
    ...
    void testC100DateErrorWhileDoingValidation() {
        ...
        BulkScanValidationResponse res =
                bulkScanValidationHelper.validateMandatoryAndOptionalFields(
                        TestDataUtil.getDateErrorData(), validationConfig.getConfig());
    ...
    void testA1FieldValidationErrorWhileDoingValidation() {
        ValidationConfig validationConfig =
                validationConfigFactory.getValidationConfig(FormType.A1.toString());
        BulkScanValidationResponse res =
                bulkScanValidationHelper.validateMandatoryAndOptionalFields(
    ...
    void testFL401AFieldValidationErrorWhileDoingValidation() {
        ValidationConfig validationConfig =
                validationConfigFactory.getValidationConfig(FormType.FL401A.toString());
        BulkScanValidationResponse res =
                bulkScanValidationHelper.validateMandatoryAndOptionalFields(
