...
class BulkScanA60ServiceTest {
    ...
    @Autowired BulkScanA60Service bulkScanValidationService;

    @Test
    void testA60Success() {
        BulkScanValidationRequest bulkScanValidationRequest =
                BulkScanValidationRequest.builder()
                        .ocrdatafields(TestDataUtil.getA60Data())
                        .build();
    ...
    void testA60Error() {
        BulkScanValidationRequest bulkScanValidationRequest =
                BulkScanValidationRequest.builder()
                        .ocrdatafields(TestDataUtil.getA60ErrorData())
                        .build();
        BulkScanValidationResponse res =
                bulkScanValidationService.validate(bulkScanValidationRequest);
    ...
    void testA60UnknownFieldsWarningsWhileDoingValidation() {
        ...
        BulkScanTransformationRequest bulkScanTransformationRequest =
                BulkScanTransformationRequest.builder().ocrdatafields(ocrDataFieldLst).build();
        ...
        assertTrue(
                bulkScanTransformationResponse
                        .getWarnings()
                        .contains(
                                String.format(UNKNOWN_FIELDS_MESSAGE, "applicant1_unknownField")));
    }
    ...
    void testA60Transform() throws IOException, JSONException {
        ...
        assertNotNull(
                bulkScanTransformationResponse
                        ...
                        .getCaseData()
                        .get(BULK_SCAN_APPLICANT_DETAILS_FIELD));
        assertTrue(
                caseData.get(BULK_SCAN_APPLICANT_DETAILS_FIELD)
                        .toString()
                        .contains(APPLICANT1_TEST_FIRSTNAME));
        assertTrue(
                caseData.get(BULK_SCAN_APPLICANT_DETAILS_FIELD)
                        .toString()
                        .contains(APPLICANT1_TEST_LASTNAME));
    }
