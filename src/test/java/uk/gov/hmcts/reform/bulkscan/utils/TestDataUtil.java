...
public final class TestDataUtil {
    ...
    public static List<OcrDataField> getA58PostPlacementData() {
        List<OcrDataField> fieldList = new ArrayList<>();
        OcrDataField ocrDataFirstNameField = new OcrDataField();
        ocrDataFirstNameField.setName("applicant1_firstName");
        ocrDataFirstNameField.setValue("firstName");
        ...
        OcrDataField birthMotherFirstNameField = new OcrDataField();
        birthMotherFirstNameField.setName("mother_firstName");
        birthMotherFirstNameField.setValue("testBirthMotherFirstName");
        fieldList.add(birthMotherFirstNameField);

        OcrDataField birthMotherLastNameField = new OcrDataField();
        birthMotherLastNameField.setName("mother_lastName");
        birthMotherLastNameField.setValue("testBirthMotherLastName");
        fieldList.add(birthMotherLastNameField);

        OcrDataField birthMotherAddressField = new OcrDataField();
        birthMotherAddressField.setName("mother_address");
        birthMotherAddressField.setValue("testBirthMotherAddress");
        fieldList.add(birthMotherAddressField);

        OcrDataField birthMotherNationalityField = new OcrDataField();
        birthMotherNationalityField.setName("mother_nationality");
        birthMotherNationalityField.setValue("testBirthMotherNationality");
        fieldList.add(birthMotherNationalityField);

        OcrDataField birthMotherOccupationField = new OcrDataField();
        birthMotherOccupationField.setName("mother_occupation");
        birthMotherOccupationField.setValue("testBirthMotherOccupation");
        fieldList.add(birthMotherOccupationField);

        OcrDataField childRelationshipFatherField = new OcrDataField();
        childRelationshipFatherField.setName("child_relationship_father");
        childRelationshipFatherField.setValue("true");
        fieldList.add(childRelationshipFatherField);

        return fieldList;
    }

    public static OcrDataField getUnknownField() {
        OcrDataField applicant = new OcrDataField();
        applicant.setName("applicant_test_field");
        applicant.setValue("false");
        return applicant;
