...
public final class TestDataUtil {
    ...
    public static List<OcrDataField> getA58Part1Data() {
        List<OcrDataField> fieldList = new ArrayList<>();
        OcrDataField ocrDataFirstNameField = new OcrDataField();
        ocrDataFirstNameField.setName("applicant1_firstName");
        ocrDataFirstNameField.setValue("firstName");
        ...
        OcrDataField fatherPartner = new OcrDataField();
        fatherPartner.setName("applicant_relationToChild_father_partner");
        fatherPartner.setValue("");
        fieldList.add(fatherPartner);

        OcrDataField motherPartner = new OcrDataField();
        motherPartner.setName("applicant_relationToChild_mother_partner");
        motherPartner.setValue("");
        fieldList.add(motherPartner);

        OcrDataField civilPartner = new OcrDataField();
        civilPartner.setName("applicant_relationToChild_non_civil_partner");
        civilPartner.setValue("");
        fieldList.add(civilPartner);
