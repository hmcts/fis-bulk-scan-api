...
class BulkScanA58ServiceRelinquishedAdoptionTest {
    ...
    @Autowired BulkScanA58Service bulkScanValidationService;
    ...
    void testA58RelinquishedAdoptionApplicationValidationSuccess() {
        ...
        BulkScanValidationResponse res =
                bulkScanValidationService.validate(
    ...
    void testA58RelinquishedAdoptionConsentTransformRequest() throws InterruptedException {
        ...
        assertEquals(
                bulkScanTransformationResponse
                        .getCaseCreationDetails()
                        .getCaseData()
                        .get("adoptionOrderConsent"),
    ...
    void testA58RelinquishedAdoptionConsentAdvanceTransformRequest() {
        ...
        assertEquals(
                bulkScanTransformationResponse
                        .getCaseCreationDetails()
                        .getCaseData()
                        .get("adoptionOrderConsentAdvance"),
    ...
    void testA58RelinquishedAdoptionConsentAgencyTransformRequest() {
        ...
        assertEquals(
                bulkScanTransformationResponse
                        .getCaseCreationDetails()
                        .getCaseData()
                        .get("adoptionOrderConsentAgency"),
                "Adoption Order Consent Agency");
    }
    ...
    void testA58RelinquishedAdoptionNoConsentTransformRequest() throws IOException, JSONException {
        ...
        assertEquals(
                bulkScanTransformationResponse
                        .getCaseCreationDetails()
                        .getCaseData()
                        .get("adoptionOrderNoConsent"),
                "adoption order no consent");
    }

    @Test
    void testA58RelinquishedAdoptionConsentParentNotFoundTransformRequest()
        ...
        assertEquals(
                bulkScanTransformationResponse
                        .getCaseCreationDetails()
                        .getCaseData()
                        .get("courtConsentParentNotFound"),
                "court consent parent not found");
    }

    @Test
    void testA58RelinquishedAdoptionConsentParentLackCapacityTransformRequest()
            throws IOException, JSONException {
        OcrDataField ocrOrderConsentAdvanceField = new OcrDataField();
        ...
        assertEquals(
                bulkScanTransformationResponse
                        .getCaseCreationDetails()
                        .getCaseData()
                        .get("courtConsentParentLackCapacity"),
                "court consent parent lack capacity");
    }

    @Test
    void testA58RelinquishedAdoptionConsentChildWelfareTransformRequest()
            throws IOException, JSONException {
        OcrDataField ocrOrderConsentAdvanceField = new OcrDataField();
